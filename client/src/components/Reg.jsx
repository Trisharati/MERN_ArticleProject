...
const Reg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let res = await dispatch(registration({ input }));
    ...
    <div>
      {isLoading ? (
        ...
        <div
          style={{
            backgroundImage:
              'url("https://images.unsplash.com/photo-1487017931017-0e0d9e02bb0c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80")',
